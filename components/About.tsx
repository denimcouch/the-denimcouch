    ...
    <section id="about" class="mt-8">
      ...
      <div class="space-y-5 text-lg">
        <p>
          ...
          things that are pretty and accessible to as many folks as possible! I
          specialize in frontend technologies, but am always comfortable finding
        ...
        <p>
          I love people. I love food. I love games found on the tabletop and on
          the screen.
        </p>
        <p>
